...
Notable changes to `deki-ble`. Engine and editor changes are in the
...
### Changed
- **Moved into the `DekiBle` namespace.** Every component was declared at global
  ...
  Code naming these types needs the namespace: `using namespace DekiBle;` or a
  qualified name.
